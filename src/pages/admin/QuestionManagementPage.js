...
import { useQuestions, useCreateQuestion, useUpdateQuestion, useDeleteQuestion } from '@hooks/index';
import { QuestionForm } from '@components/question-form/QuestionForm';
import { Card, Button, Modal, Alert, EmptyState, Pagination } from '@components/common';
export const QuestionManagementPage = () => {
    const navigate = useNavigate();
    const [page, setPage] = useState(1);
    const { data: questions, total, loading, refetch } = useQuestions({ page, limit: 10 });
